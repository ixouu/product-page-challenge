...
const LikeIcon = () => {
  ...
  return (
      <div className="relative w-[30px] h-[30px] text-purple-900">
        {!isLiked ? <button onClick={(e)=> handleClick(e)}><FontAwesomeIcon icon={faHeart} className=" text-2xl ease-out duration-200 hover:scale-125 xl:text-4xl" aria-label="Ajoute un j'aime au produit"/></button> :(
          <>
                  <button onClick={(e)=> handleClick(e)}><FontAwesomeIcon icon={faHeart2} className="faHeart text-2xl ease-out duration-200 hover:scale-125 xl:text-4xl" aria-label="Retire un j'aime au produit"/></button>
