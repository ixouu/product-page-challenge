...
const Discount = () => {
  ...
  return (
    <>
        {isReduce
        ?    <button 
        className='fixed w-12 h-12 bg-black rounded-full text-white -right-[20px] bottom-[220px]'
        ...
        <button 
        className='absolute bg-black rounded-full w-6 h-6 -top-[10px]' 
        onClick={(e) =>{e.preventDefault(); setIsReduce(!isReduce)}}
